...
export default function Requests() {
  ...
  useEffect(() => {
    console.log('🚀 [Requests] useEffect executando...');
    console.log('🚀 [Requests] Componente montado!');
    buscarRequisicoes();
    console.log('🚀 [Requests] Chamando carregarLocais...');
    carregarLocais();
    console.log('🚀 [Requests] Chamando carregarDepartamentos...');
    carregarDepartamentos();
    console.log('🚀 [Requests] useEffect finalizado!');
  }, []);

  // Carregar locais da API
  const carregarLocais = async () => {
    console.log('🔍 [Requests] carregarLocais chamada!');
    try {
      ...
      if (data.success && data.data) {
        ...
        console.log('✅ Locais formatados:', options);
  ...
  const carregarDepartamentos = async () => {
    console.log('🔍 [Requests] carregarDepartamentos chamada!');
    try {
      ...
      const data = await response.json();
      console.log('✅ Resposta da API de departamentos:', data);
      ...
      if (data.success && data.data) {
        ...
        console.log('✅ Departamentos formatados:', options);
